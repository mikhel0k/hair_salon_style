...
class TestUpdateMaster:
    ...
    @pytest.mark.parametrize("specialization_id, name, phone, email, status", [
        ...
        (data_for_id.right_id, name.right_name_сyrillic, phone.right_number_str_with_eight, email.right_string_mail, Status.right_active),
        ...
        (None, None, phone.right_number_str_with_eight, None, None),
