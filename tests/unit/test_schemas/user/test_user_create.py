...
class TestUserCreate:
    ...
    def test_user_create_with_another_number(self):
        data = {
    ...
    def test_user_create_with_another_country_number(self):
        data = {
    ...
    def test_user_create_with_short_number(self):
        data = {
    ...
    def test_user_create_with_long_number(self):
        data = {
    ...
    def test_user_create_without_none_in_number(self):
        data = {
            "phone_number": None,
        }
        with pytest.raises(ValidationError) as exc_info:
    ...
    def test_user_create_with_int(self):
        data = {
            "phone_number": 88005553535,
        }
        user = UserCreate(**data)
