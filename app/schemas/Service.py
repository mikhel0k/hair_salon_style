...
class ServiceBase(BaseModel):
    ...
    category_id: Annotated[StrictInt, Field(..., ge=1, description="Category of the service")]
...
class ServiceResponse(ServiceBase):
    id: Annotated[StrictInt, Field(..., ge=1, description="ID of the service")]
...
class ServiceUpdate(BaseModel):
    ...
    category_id: Annotated[Optional[StrictInt], Field(None, ge=1, description="Category of the service")]
