...
class ServiceBase(BaseModel):
    ...
    price: Annotated[decimal.Decimal, Field(..., ge=0, le=10000, description="Price of the service")]
...
class ServiceUpdate(BaseModel):
    ...
    price: Annotated[Optional[decimal.Decimal], Field(None, ge=0, le=10000, description="Price of the service")]
