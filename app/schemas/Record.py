...
class RecordResponse(BaseModel):
    ...
    date: Annotated[date, Field(..., description="Date of record", examples=[date.today()])]
    time: Annotated[time, Field(..., description="Time of record", examples=[time(14, 30)])]
    status: Annotated[str, Field(None, max_length=30, description="Status of record", examples=ALLOWED_STATUSES)]
    price: Annotated[float, Field(None, description="Price of record", examples=[500, 1500, 1410.10])]
